...
public interface NoteDAO<N extends Note, D extends Document> {
	 ...
	 * 
	 * @param note
	 *            The note object that should be deleted.
	 */
	 ...
	 * 
	 * @param tag
	 *            The tag object that should be deleted.
	 */
	 ...
	 *            The search text.
	 * @param caseSentitive
	 *            True if the search requires case sensitive; false otherwise.
	 * @param exactSearch
	 *            True if the search requires exact search; false otherwise.
