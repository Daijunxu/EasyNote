...
public class BookNoteDAO extends AbstractNoteDAO {
	 ...
	 * @param documentId
	 *            The document ID of the document that the chapter belongs to.
	 */
	 ...
	 * 
	 * @param chapter
	 *            The chapter to merge.
	 * @param documentId
	 *            The document ID of the book that the chapter belongs to.
	 ...
	 *            The chapter to save.
	 * @param documentId
	 *            The document ID of the book that the new chapter belongs to.
