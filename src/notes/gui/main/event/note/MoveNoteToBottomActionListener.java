...
/**
 * Defines event listener to move the selected note to the bottom in the relative locations of all notes in the collection.
 * <p/>
 * Author: Rui Du
 * Date: 4/22/14
 * Time: 9:51 PM
 */
public class MoveNoteToBottomActionListener implements ActionListener {
