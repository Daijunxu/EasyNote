...
/**
 * Defines event listener to move the selected note up in the relative locations of all notes in the collection.
 * <p/>
 * Author: Rui Du
 * Date: 4/22/14
 * Time: 9:51 PM
 */
public class MoveNoteUpActionListener implements ActionListener {
