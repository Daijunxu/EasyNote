...
/**
 * Defines event listener for moving worksheet down in the relative locations of all worksheets in the current workset.
 * <p/>
 * Author: Rui Du
 * Date: 4/14/14
 * Time: 11:51 PM
 */
public class MoveWorksheetDownActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        try {
            if (logic.getCurrentWorkset() == null) {
                ...
                WorksetBusinessLogic.get().moveCurrentWorksheetDown();
