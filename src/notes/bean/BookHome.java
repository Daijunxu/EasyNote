...
public class BookHome implements Serializable {
	 ...
	 * 
	 * @param currentBook
	 *            The current selected book to set.
	 */
	 ...
	 * 
	 * @param currentBookNote
	 *            The current selected book note to set.
	 */
	 ...
	 * 
	 * @param currentBookNotesList
	 *            The list of book note in current selected chapter to set.
	 */
	 ...
	 *            The current selected chapter to set.
	 */
	 ...
	 * 
	 * @param currentChapterList
	 *            The list of chapters in current selected book to set.
	 */
	 ...
	 * 
	 * @param currentChapterNotesMap
	 *            The map from chapter IDs to notes in current selected book to set.
	 */
	 ...
	 * 
	 * @param documentId
	 *            The current selected document ID.
	 * @param chapterId
	 *            The current selected chapter ID.
	 * @param noteId
	 *            The current selected note ID.
	 */
