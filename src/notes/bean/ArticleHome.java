...
public class ArticleHome implements Serializable {
	 ...
	 *            The current selected article to set.
	 */
	 ...
	 * 
	 * @param currentArticleNote
	 *            The current selected article note to set.
	 */
	 ...
	 * 
	 * @param currentArticleNotesList
	 *            The list of article note in current selected article to set.
	 */
